...
const Navbar = ({ scheduleType, setScheduleType }) => {
    ...
    return (
        <div
            className={`navbar rounded-lg shadow gap-2 px-5 transition-colors duration-200 ${
        ...
        >
            <div className="flex-1">
                ...
                <a
                    href="https://github.com/prathamreet/timetable"
                    target="_blank"
                    rel="noopener noreferrer"
                >
                    <div className="btn btn-ghost text-xl transition-colors hover:bg-transparent">
                        <svg
